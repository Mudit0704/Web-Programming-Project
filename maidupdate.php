  ...
  <div class="jumbotron" style="background-color: #44a08d;">
    <?php
        extract($_POST);
            ...
            $mid=$id;
            include 'config.php';
            $sql="SELECT Name FROM maidhired WHERE mid=$id";
            ...
            if ($result->num_rows > 0) {
              ...
              $sql1 = "INSERT INTO maidhired (uid,mid,Name,Sex,Rating,Building,Flat_no) VALUES ($uid,$mid,'$name','$sex',$rating,'$building',$flat)";
